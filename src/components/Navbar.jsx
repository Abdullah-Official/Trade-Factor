    ...
    return (
        <li>
            <NavLink to={`/${children !== "Home" ? children.toLowerCase().replace(/ /g, "-") : ""}`}>
                <p
                    className="!font-[400] text-white text-[17px] hover:text-[#45D1FD] "
                >
                    {children}
                </p>
            </NavLink>
        ...
        <Navbar shadow={false} fullWidth className="border-0 backdrop-filter-none py-8 fixed z-50  " style={{background: "rgb(1,11,36)"}}>
            <div className="container mx-auto flex items-center justify-between">
                ...
                <div className="hidden items-center  lg:flex">
                    <NavLink to={"/login"}>
                        <Button variant="text" className='text-white !w-fit font-[7p0] hover:text-[#45D1FD]  capitalize text-[14px]'>Sign In</Button>
                        ...
                        <button className="flex-1 text-[14px]  text-w7pte hover:text-[#45D1FD]  font-[500] bg-[#010B24] px-6 xl:px-8 py-3 rounded-full">
                            Get Started
                        </button>
                    </NavLink>
                </div>
                ...
                <div className="container mx-auto mt-3 border-t border-blue-gray-50 px-2 pt-4">
                    ...
                    <div className="mt-6 mb-4 flex items-center gap-2">
                        ...
                        <NavLink to="/get-started"
                            ...
                            <button className="flex-1 text-[14px]  text-w7pte hover:text-[#45D1FD]  font-[500] bg-[#010B24] px-5 xl:px-8 py-2 rounded-full">
                                Get Started
                            </button>
                        </NavLink>
                    </div>
