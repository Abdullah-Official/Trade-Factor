        ...
        <div className="space-y-24 my-20 container mx-auto px-5">
            <div className="grid grid-cols-1 items-center justify-between lg:grid-cols-2 gap-8">
                <div className='space-y-8 lg:space-y-12'>
                    ...
                    <div className='max-w-5xl w-full bg-[#02539A40] p-12 pt-16 rounded-3xl'>
                        <div className='grid grid-cols-1 gap-6'>
                            ...
                            <div className='flex justify-between items-center'>
                                <div className="flex  items-center">
                                    ...
                                    <p className='text-white font-[400] text-[14px]'>Remember me</p>
                                </div>
                                <p className='text-white font-[400] text-[14px] cursor-pointer'>Forgot Password</p>
                            </div>
                        </div>
